...
func TestValidate_ScalarLeafs_ValidScalarSelection(t *testing.T) {
	expectPassesRule(t, graphql.ScalarLeafsRule, `
...
func TestValidate_ScalarLeafs_ObjectTypeMissingSelection(t *testing.T) {
	expectFailsRule(t, graphql.ScalarLeafsRule, `
      query directQueryOnObjectWithoutSubFields {
        human
      }
    `, []gqlerrors.FormattedError{
		ruleError(`Field "human" of type "Human" must have a sub selection.`, 3, 9),
	})
}
...
func TestValidate_ScalarLeafs_InterfaceTypeMissingSelection(t *testing.T) {
    ...
    `, []gqlerrors.FormattedError{
		ruleError(`Field "pets" of type "[Pet]" must have a sub selection.`, 3, 17),
	})
}
...
func TestValidate_ScalarLeafs_ScalarSelectionNotAllowedOnBoolean(t *testing.T) {
    ...
    `, []gqlerrors.FormattedError{
		ruleError(`Field "barks" of type "Boolean" must not have a sub selection.`, 3, 15),
	})
}
func TestValidate_ScalarLeafs_ScalarSelectionNotAllowedOnEnum(t *testing.T) {
    ...
    `, []gqlerrors.FormattedError{
		ruleError(`Field "furColor" of type "FurColor" must not have a sub selection.`, 3, 18),
	})
}
func TestValidate_ScalarLeafs_ScalarSelectionNotAllowedWithArgs(t *testing.T) {
    ...
    `, []gqlerrors.FormattedError{
		ruleError(`Field "doesKnowCommand" of type "Boolean" must not have a sub selection.`, 3, 42),
	})
}
func TestValidate_ScalarLeafs_ScalarSelectionNotAllowedWithDirectives(t *testing.T) {
    ...
    `, []gqlerrors.FormattedError{
		ruleError(`Field "name" of type "String" must not have a sub selection.`, 3, 33),
	})
}
func TestValidate_ScalarLeafs_ScalarSelectionNotAllowedWithDirectivesAndArgs(t *testing.T) {
    ...
    `, []gqlerrors.FormattedError{
		ruleError(`Field "doesKnowCommand" of type "Boolean" must not have a sub selection.`, 3, 61),
	})
}
