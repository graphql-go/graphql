...
func TestValidate_VariableDefaultValuesOfCorrectType_VariablesWithNoDefaultValues(t *testing.T) {
	expectPassesRule(t, graphql.DefaultValuesOfCorrectTypeRule, `
...
func TestValidate_VariableDefaultValuesOfCorrectType_NoRequiredVariablesWithDefaultValues(t *testing.T) {
	expectFailsRule(t, graphql.DefaultValuesOfCorrectTypeRule, `
...
func TestValidate_VariableDefaultValuesOfCorrectType_VariablesWithInvalidDefaultValues(t *testing.T) {
    ...
    `,
		[]gqlerrors.FormattedError{
			ruleError(`Variable "$a" of type "Int" has invalid default value: "one".`, 3, 19),
			ruleError(`Variable "$b" of type "String" has invalid default value: 4.`, 4, 22),
			ruleError(`Variable "$c" of type "ComplexInput" has invalid default value: "notverycomplex".`, 5, 28),
		})
}
...
func TestValidate_VariableDefaultValuesOfCorrectType_ComplexVariablesMissingRequiredField(t *testing.T) {
    ...
    `,
		[]gqlerrors.FormattedError{
			ruleError(`Variable "$a" of type "ComplexInput" has invalid default value: {intField: 3}.`, 2, 53),
		})
}
...
func TestValidate_VariableDefaultValuesOfCorrectType_ListVariablesWithInvalidItem(t *testing.T) {
    ...
    `,
		[]gqlerrors.FormattedError{
			ruleError(`Variable "$a" of type "[String]" has invalid default value: ["one", 2].`, 2, 40),
		})
}
